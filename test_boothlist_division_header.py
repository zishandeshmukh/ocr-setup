#!/usr/bin/env python3
"""
Test header extraction on boothlist_division template
"""
...
def test_boothlist_division_header():
    """Test header extraction with boothlist_division template"""
    
    print("🔧 Initializing API...")
    api = API()
    print("✅ API initialized\n")
    
    # Set template to boothlist_division
    template_name = 'boothlist_division'
    print(f"📐 Setting template: {template_name}")
    result = api.set_template(template_name)
    print(f"✅ {result}\n")
    
    # Try with ZP Boothwise PDF (BoothList_Division format)
    pdf_path = 'samples/Zp_Boothwise/BoothList_Division_33_Booth_6_A4 राजोली.pdf'
    print(f"📄 Testing: {pdf_path}")
    print("   Processing page 6\n")
    ...
    print("\n" + "="*80)
    print("📊 BOOTHLIST_DIVISION HEADER EXTRACTION RESULTS")
    print("="*80)
    ...
    if coverage == 100:
        ...
        print("\n" + "="*80)
        print("✅ BOOTHLIST_DIVISION TEMPLATE TEST PASSED!")
        print("="*80)
        return True
    else:
...
if __name__ == '__main__':
    success = test_boothlist_division_header()
